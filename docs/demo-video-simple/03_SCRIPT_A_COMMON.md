...
검은 배경, **"Getting around"**. 음성 없음.

## A1 · 브리핑 (0:02–0:16)

- **화면**: 모달 *What you're working from* — **YOUR TASK IN THIS ROUND**(과제 문장) → 스크롤 → **THE ASSIGNMENT STUDENTS WERE GIVEN** → **THE CHATBOT'S STARTING PROMPT**. **Start** 클릭 → 보드. 커서를 헤더 **ⓘ Your task**에 1초.
...
- **화면**: P19 · 2 행 호버 → 📌(**Keep this one in view**) 클릭 → 리스트 위에 **Kept in view · 1** 박스(*Stays here whatever you have selected*), 리스트 헤더에 *· 1 kept above*. 아무 행이나 하나 클릭해 선택을 바꿔도 선반이 그대로임을 1초. 선반의 📌로 해제 → 박스 사라짐.
