...
> Simple 스터디용 워크스루 4편을 찍고 발행하기까지. 기획 `01_PLAN.md` · 시나리오/원문 `02_SCENARIO.md` · 스크립트 `03/04/05_SCRIPT_*.md` · 녹음 `06_NARRATION.md`. `shots/`는 2026-08-22 실제 화면.
>
...
- [ ] ⓑ: 두 경로(행 `+` / `+ New intent`)가 다 나왔다 · Examples 추가 ✨와 **Least like these** 전환이 나왔다 · 모델 예시 3(이탤릭)이 보였다
- [ ] ⓒ: 핀 2개가 선반에 있었고 **Apply마다 선반에서 확인**했다 · 문서가 두 사이클에 걸쳐 자랐다 · 버전 드롭다운에서 **Original (as delivered)** 를 골랐다 돌아왔다
- [ ] 마지막: **Deployed vN** + **I'm done**(누르지 않음)
...
- SimpleStudio의 라벨(Kept in view · Working out this reply under · Examples · Most/Least like these · Starter sets · Add …) → 스크립트 인용 수정.
- 데모 20명 구성 → `02_SCENARIO` §3의 재료 표(앵커 P19 · 2, 대필 P11 · 1)와 §4 원문 재선정.
